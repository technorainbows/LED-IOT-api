(function(global) {
    ...
    function updateOnButton(device) {
        ...
        // $("#onSwitch").prop("checked", device[1]['onState']);
        // $('input[name=onSwitch]').prop('checked', Boolean(device[1]['onState']));
        ...
        switch (device[1]['onState']) {
            case "true":
                ...
                // $('input:checkbox[name=onSwitch]').attr('checked', true);
            ...
            case "false":
                ...
                // $('input:checkbox[name=onSwitch]').attr('checked', false);
